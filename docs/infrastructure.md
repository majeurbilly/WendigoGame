...
- **Certificat OIDC** : `@pulumi/tls` génère une paire RSA auto-signée importée dans Authentik (`Wendigo: OIDC Signing (RSA)`). Garantit JWKS RS256 même si le certificat bootstrap Authentik est absent ou renommé.

    ...
    public class ManualTest
    {
        ...
        private static void TesterSystemeDeRoles()
        {
            ...
            GameActionContext context = new GameActionContext
            {
                ...
                GameId = "test-game",
                CurrentPhase = GamePhase.Night // Le loup ne peut utiliser son pouvoir que la nuit
            };

            if (!loup.CanUsePower(context)) throw new Exception("Erreur: Le loup devrait pouvoir utiliser son pouvoir la nuit");
